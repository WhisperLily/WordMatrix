...
class WordManager:  #this class manages anything to do with words
    def __init__(self):      #Initialise variables
     #list of predefined words to be used for the game.
        self.dictionary = ['example','mischievous','conscientious','xylophone','ambiguous','python','hypnotic','labyrinth','scrabble',
                           'monopoly','nauseous','javascript','scholarship','psychiatrist','ancient','authorise','semantic','beseech',
